...
function SampleSurveyTable({ queryParams, setQueryParams, updated }: AllSurveysProps) {
  ...
  async function handleGetAllSurveys() {
    ...
    setLoading(true);
    const response = await getSampleSurveys(params);
...
export default SampleSurveyTable;
