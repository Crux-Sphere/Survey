    ...
    useEffect(() => {
        const fetchSurveys = async () => {
            ...
            try {
                ...
                setOptions(surveysData.map((survey: any) => ({
                    value: survey._id,
                    label: survey.name,
                })));
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div className="flex flex-col w-[352px]">
                                    <Select2
                                        key={selectKey}
                                        value={surveyId ? options.find((option) => option.value === surveyId) : null}
                                ...
                                <div className="flex flex-col w-[352px]">
                                    <Select2
                                        value={caste ? casteOptions.find((option) => option.value === caste) : null}
                                        onChange={(selectedOption) => {
                                ...
                                <div className="flex space-x-2">
                                    ...
                                    disabled={!needsApply || !surveyId || !caste || !startDate || !endDate}
